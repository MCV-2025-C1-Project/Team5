...
def main():
    ...
    parser.add_argument(
        ...
        choices=['rgb', 'hsv', 'ycbcr', 'lab', 'grayscale', 'hsv', 'lab',
                 ...
                 'spatial_pyramid_2d_lab', 'spatial_pyramid_2d_hsv',
                 'spatial_pyramid_3d_lab', 'spatial_pyramid_3d_hsv',
                 'block_histogram_lab', 'block_histogram_hsv_2x2', 'block_histogram_hsv_4x4',
                 'block_histogram_hsv_8x8', 'block_histogram_hsv_16x16',
                 'block_histogram_2d_lab', 'block_histogram_2d_hsv',
                 'block_histogram_3d_lab', 'block_histogram_3d_hsv'],
